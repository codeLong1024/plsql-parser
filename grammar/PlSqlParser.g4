...
audit_direct_path
    : /* Java predicate removed:  */ DIRECT_PATH auditing_by_clause
    ;

audit_container_clause
    : /* Java predicate removed:  */ (CONTAINER EQUALS_OP (CURRENT | ALL))
    ;
...
auditing_on_clause
    : ON (
        ...
        | /* Java predicate removed:  */ SQL TRANSLATION PROFILE profile_name
        | DEFAULT
    )
    ;
...
sql_statement_shortcut
    ...
    | NOT EXISTS
    | OUTLINE
    | /* Java predicate removed:  */ PLUGGABLE DATABASE
    | PROCEDURE
    | PROFILE
...
library_editionable
    : /* Java predicate removed:  */ (EDITIONABLE | NONEDITIONABLE)
    ;

library_debug
    : /* Java predicate removed:  */ DEBUG
    ;
...
partial_database_recovery_10g
    : /* Java predicate removed:  */ STANDBY (
        TABLESPACE tablespace (',' tablespace)*
        | DATAFILE CHAR_STRING
        | filenumber (',' CHAR_STRING | filenumber)*
...
period_definition
    : /* Java predicate removed:  */ PERIOD FOR column_name ('(' start_time_column ',' end_time_column ')')?
    ;
...
dml_table_expression_clause
    ...
    | /* Java predicate removed:  */ (RELATIONAL '(' tableview_name NOT XMLTYPE ')')
    ;
